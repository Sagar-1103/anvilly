      ...
      <div className="flex items-center gap-2 ml-auto">
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="relative w-6 h-6 rounded-full overflow-hidden border border-white/[0.08] flex items-center justify-center text-[10px] font-bold cursor-pointer hover:border-white/30 focus:outline-none transition-colors"
          >
            {userImage ? (
              <img
                src={userImage}
