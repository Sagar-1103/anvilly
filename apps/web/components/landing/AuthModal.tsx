...
export default function AuthModal({ isOpen, onClose, initialMode = "login" }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-3xl p-0.5 bg-gradient-to-b from-zinc-700/50 via-zinc-800/30 to-zinc-900/50 shadow-2xl shadow-black animate-fade-in-up">
        <div className="bg-[#09090c] rounded-[22px] p-6 backdrop-blur-xl border border-zinc-800/80 relative">
          ...
          <button
            ...
            className="absolute top-5 right-5 w-7 h-7 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white flex items-center justify-center border border-zinc-800/80 transition-colors cursor-pointer"
          >
          ...
          <div className="space-y-2 mb-4">
            {/* Google */}
            <button className="w-full py-2.5 px-3.5 rounded-xl bg-zinc-950 hover:bg-zinc-900 border border-zinc-800/80 text-zinc-200 text-xs font-semibold flex items-center justify-center gap-2.5 transition-all cursor-pointer">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-2">
            <div>
              <input
                ...
                className="w-full bg-zinc-950 border border-zinc-800/80 rounded-xl text-xs text-zinc-100 placeholder:text-zinc-600 px-3.5 py-2.5 focus:outline-none focus:border-zinc-700 transition-colors"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-2.5 mt-1 rounded-xl bg-white text-black text-xs font-bold hover:bg-zinc-200 transition-all shadow-sm cursor-pointer"
            >
            ...
            {mode === "login" ? (
              <p className="text-xs text-zinc-500">
                ...
                <button
                  ...
                  className="text-white hover:underline font-semibold transition-all cursor-pointer ml-1"
                >
                  Sign up
                </button>
              </p>
